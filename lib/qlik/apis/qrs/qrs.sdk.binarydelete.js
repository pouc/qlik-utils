        ...
        binarydelete: {
            ...
            id: function(id) {
                return {
                    ...
                    get: function(appendprivileges) {
                        ...
                        return base.request({
                            restUri: options.qrsRestUri + '/qrs/binarydelete/' + id + '' + core.ifNotUndef(appendprivileges, '?privileges=' + appendprivileges, ''),
                            pfx: options.pfx,
            ...
            count: {
                ...
                get: function(filter) {
                    ...
                    return base.request({
                        restUri: options.qrsRestUri + '/qrs/binarydelete/count' + core.ifNotUndef(filter, '?filter=' + filter, ''),
                        pfx: options.pfx,
                        passPhrase: options.passPhrase,
                        key: options.key,
                        cert: options.cert,
            ...
            full: {
                ...
                get: function(filter, orderby, appendprivileges) {
                    ...
                    return base.request({
                        restUri: options.qrsRestUri + '/qrs/binarydelete/full' + (core.ifNotUndef(filter, '&filter=' + filter, '') +
            ...
            table: {
                ...
                post: function(postParams, filter, skip, take, sortcolumn, orderascending) {
                    ...
                    return base.request({
                        restUri: options.qrsRestUri + '/qrs/binarydelete/table' + (core.ifNotUndef(filter, '&filter=' + filter, '') +
            ...
            get: function(filter, orderby, appendprivileges) {
                ...
                return base.request({
                    restUri: options.qrsRestUri + '/qrs/binarydelete' + (core.ifNotUndef(filter, '&filter=' + filter, '') +
                        core.ifNotUndef(orderby, '&orderby=' + orderby, '') +
                        core.ifNotUndef(appendprivileges, '&privileges=' + appendprivileges, '')).replace(/^&/, '?'),
                    pfx: options.pfx,
                    passPhrase: options.passPhrase,
