    ...
    return {
        ...
        appavailability: {
            ...
            id: function(id) {
                return {
                    ...
                    get: function(appendprivileges) {
                        ...
                        return base.request({
                            restUri: options.qrsRestUri + '/qrs/appavailability/' + id + '' + core.ifNotUndef(appendprivileges, '?privileges=' + appendprivileges, ''),
                            pfx: options.pfx,
            ...
            count: {
                 ...
                 * This method is generated
                 *
                 * @memberOf appavailability.count
                 *
                 * @example
                 * ```javascript
                ...
                get: function(filter) {
                    ...
                    return base.request({
                        restUri: options.qrsRestUri + '/qrs/appavailability/count' + core.ifNotUndef(filter, '?filter=' + filter, ''),
                        pfx: options.pfx,
                        passPhrase: options.passPhrase,
                        key: options.key,
                        cert: options.cert,
            ...
            full: {
                ...
                get: function(filter, orderby, appendprivileges) {
                    ...
                    return base.request({
                        restUri: options.qrsRestUri + '/qrs/appavailability/full' + (core.ifNotUndef(filter, '&filter=' + filter, '') +
            ...
            table: {
                 ...
                 * This method is generated
                 *
                 * @memberOf appavailability.table
                 *
                 * @example
                 * ```javascript
                ...
                post: function(postParams, filter, skip, take, sortcolumn, orderascending) {
                    ...
                    return base.request({
                        restUri: options.qrsRestUri + '/qrs/appavailability/table' + (core.ifNotUndef(filter, '&filter=' + filter, '') +
            ...
            get: function(filter, orderby, appendprivileges) {
                ...
                return base.request({
                    restUri: options.qrsRestUri + '/qrs/appavailability' + (core.ifNotUndef(filter, '&filter=' + filter, '') +
                        core.ifNotUndef(orderby, '&orderby=' + orderby, '') +
                        core.ifNotUndef(appendprivileges, '&privileges=' + appendprivileges, '')).replace(/^&/, '?'),
                    pfx: options.pfx,
                    passPhrase: options.passPhrase,
