    ...
    return {
        ...
        about: {
            ...
            get: function() {
                ...
                return base.request({
                    restUri: options.qrsRestUri + '/qrs/about',
                    pfx: options.pfx,
            ...
            api: {
                ...
                default: {
                    ...
                    app: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/app' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    appavailability: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/appavailability' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    appcontentquota: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/appcontentquota' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    appseedinfo: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/appseedinfo' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    appstatus: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/appstatus' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    binarydelete: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/binarydelete' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    binarydownload: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/binarydownload' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    binarysyncruleevaluation: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/binarysyncruleevaluation' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    compositeevent: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/compositeevent' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    compositeeventoperational: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/compositeeventoperational' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    compositeeventruleoperational: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/compositeeventruleoperational' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    content: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/content' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    contentlibrary: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/contentlibrary' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    custompropertydefinition: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/custompropertydefinition' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    dataconnection: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/dataconnection' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    datasegment: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/datasegment' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    detail: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/detail' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    engineservice: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/engineservice' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    engineservicetemplate: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/engineservicetemplate' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    executionresult: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/executionresult' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    executionsession: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/executionsession' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    extension: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/extension' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    externalchangeinfo: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/externalchangeinfo' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    externalprogramtask: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/externalprogramtask' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    externalprogramtaskoperational: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/externalprogramtaskoperational' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    filereference: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/filereference' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    followingapp: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/followingapp' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    internal: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/internal' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    license: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/license' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    localconfig: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/localconfig' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    loginaccesstype: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/loginaccesstype' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    loginaccessusage: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/loginaccessusage' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    mimetype: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/mimetype' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    object: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/object' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    printingservice: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/printingservice' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    printingservicetemplate: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/printingservicetemplate' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    proxyservice: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/proxyservice' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    proxyservicetemplate: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/proxyservicetemplate' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    recentapp: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/recentapp' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    reloadtask: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/reloadtask' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    reloadtaskoperational: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/reloadtaskoperational' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    removedsystemrule: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/removedsystemrule' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    repositoryservice: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/repositoryservice' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    repositoryservicetemplate: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/repositoryservicetemplate' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    schedulerservice: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/schedulerservice' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    schedulerservicetemplate: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/schedulerservicetemplate' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    schemaevent: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/schemaevent' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    schemaeventoperational: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/schemaeventoperational' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    selection: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/selection' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    servernodeconfiguration: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/servernodeconfiguration' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    servicestatus: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/servicestatus' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    staticcontentreference: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/staticcontentreference' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    stream: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/stream' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    syncsession: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/syncsession' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    systeminfo: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/systeminfo' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    systemrule: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/systemrule' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    tabledefinition: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/tabledefinition' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    tag: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/tag' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    tempcontent: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/tempcontent' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    termsacceptance: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/termsacceptance' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    user: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/user' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    useraccessgroup: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/useraccessgroup' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    useraccesstype: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/useraccesstype' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    useraccessusage: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/useraccessusage' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    userdirectory: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/userdirectory' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    userdirectorytemplate: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/userdirectorytemplate' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    usersynctask: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/usersynctask' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    usersynctaskoperational: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/usersynctaskoperational' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    virtualproxyconfig: {
                        ...
                        get: function(listentries) {
                            ...
                            return base.request({
                                restUri: options.qrsRestUri + '/qrs/about/api/default/virtualproxyconfig' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                pfx: options.pfx,
                                passPhrase: options.passPhrase,
                                key: options.key,
                                cert: options.cert,
                    ...
                    get: function(listentries) {
                        ...
                        return base.request({
                            restUri: options.qrsRestUri + '/qrs/about/api/default' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                            pfx: options.pfx,
                            passPhrase: options.passPhrase,
                            key: options.key,
                            cert: options.cert,
                ...
                description: {
                    ...
                    get: function(extended, method, format) {
                        ...
                        return base.request({
                            restUri: options.qrsRestUri + '/qrs/about/api/description' + (core.ifNotUndef(extended, '&extended=' + extended, '') +
                ...
                enums: {
                    ...
                    get: function() {
                        ...
                        return base.request({
                            restUri: options.qrsRestUri + '/qrs/about/api/enums',
                            pfx: options.pfx,
                            passPhrase: options.passPhrase,
                            key: options.key,
                            cert: options.cert,
                ...
                relations: {
                    ...
                    get: function() {
                        ...
                        return base.request({
                            restUri: options.qrsRestUri + '/qrs/about/api/relations',
                            pfx: options.pfx,
                            passPhrase: options.passPhrase,
                            key: options.key,
                            cert: options.cert,
