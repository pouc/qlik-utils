            ...
            api: {
                ...
                default: {
                    ...
                    applicationaccessgroup: {
                         ...
                         * This method is manual
                         *
                         * @memberOf about.api.default.applicationaccessgroup
                         *
                         * @example
                         * ```javascript
                        ...
                        get: function(listentries) {
                            return base.request(extend(true, {}, options, {
                                restUri: options.qrsRestUri + '/qrs/about/api/default/applicationaccessgroup' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                method: 'GET'
                            }));
                        }
                    },
                    ...
                    applicationaccesstype: {
                         ...
                         * This method is manual
                         *
                         * @memberOf about.api.default.applicationaccesstype
                         *
                         * @example
                         * ```javascript
                        ...
                        get: function(listentries) {
                            return base.request(extend(true, {}, options, {
                                restUri: options.qrsRestUri + '/qrs/about/api/default/applicationaccesstype' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                method: 'GET'
                            }));
                        }
                    },
                    ...
                    applicationaccessusage: {
                         ...
                         * This method is manual
                         *
                         * @memberOf about.api.default.applicationaccessusage
                         *
                         * @example
                         * ```javascript
                        ...
                        get: function(listentries) {
                            return base.request(extend(true, {}, options, {
                                restUri: options.qrsRestUri + '/qrs/about/api/default/applicationaccessusage' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                method: 'GET'
                            }));
                        }
                    },
                    ...
                    proxyservicecertificate: {
                         ...
                         * This method is manual
                         *
                         * @memberOf about.api.default.proxyservicecertificate
                         *
                         * @example
                         * ```javascript
                        ...
                        get: function(listentries) {
                            return base.request(extend(true, {}, options, {
                                restUri: options.qrsRestUri + '/qrs/about/api/default/proxyservicecertificate' + core.ifNotUndef(listentries, '?listentries=' + listentries, ''),
                                method: 'GET'
                            }));
                        }
                    },
