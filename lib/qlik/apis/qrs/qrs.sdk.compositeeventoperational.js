        ...
        compositeeventoperational: {
            ...
            id: function(id) {
                return {
                    ...
                    delete: function() {
                        ...
                        return base.request({
                            restUri: options.qrsRestUri + '/qrs/compositeeventoperational/' + id + '',
                            pfx: options.pfx,
                    ...
                    get: function(appendprivileges) {
                        ...
                        return base.request({
                            restUri: options.qrsRestUri + '/qrs/compositeeventoperational/' + id + '' + core.ifNotUndef(appendprivileges, '?privileges=' + appendprivileges, ''),
                            pfx: options.pfx,
                            passPhrase: options.passPhrase,
                            key: options.key,
                            cert: options.cert,
            ...
            count: {
                ...
                get: function(filter) {
                    ...
                    return base.request({
                        restUri: options.qrsRestUri + '/qrs/compositeeventoperational/count' + core.ifNotUndef(filter, '?filter=' + filter, ''),
                        pfx: options.pfx,
                        passPhrase: options.passPhrase,
                        key: options.key,
                        cert: options.cert,
            ...
            full: {
                ...
                get: function(filter, orderby, appendprivileges) {
                    ...
                    return base.request({
                        restUri: options.qrsRestUri + '/qrs/compositeeventoperational/full' + (core.ifNotUndef(filter, '&filter=' + filter, '') +
            ...
            many: {
                ...
                post: function(postParams, appendprivileges) {
                    ...
                    return base.request({
                        restUri: options.qrsRestUri + '/qrs/compositeeventoperational/many' + core.ifNotUndef(appendprivileges, '?privileges=' + appendprivileges, ''),
                        pfx: options.pfx,
                        passPhrase: options.passPhrase,
                        key: options.key,
                        cert: options.cert,
            ...
            previewcreateprivilege: {
                ...
                post: function(postParams) {
                    ...
                    return base.request({
                        restUri: options.qrsRestUri + '/qrs/compositeeventoperational/previewcreateprivilege',
                        pfx: options.pfx,
                        passPhrase: options.passPhrase,
                        key: options.key,
                        cert: options.cert,
            ...
            table: {
                ...
                post: function(postParams, filter, skip, take, sortcolumn, orderascending) {
                    ...
                    return base.request({
                        restUri: options.qrsRestUri + '/qrs/compositeeventoperational/table' + (core.ifNotUndef(filter, '&filter=' + filter, '') +
            ...
            get: function(filter, orderby, appendprivileges) {
                ...
                return base.request({
                    restUri: options.qrsRestUri + '/qrs/compositeeventoperational' + (core.ifNotUndef(filter, '&filter=' + filter, '') +
                        core.ifNotUndef(orderby, '&orderby=' + orderby, '') +
                        core.ifNotUndef(appendprivileges, '&privileges=' + appendprivileges, '')).replace(/^&/, '?'),
                    pfx: options.pfx,
                    passPhrase: options.passPhrase,
            ...
            post: function(postParams, appendprivileges) {
                ...
                return base.request({
                    restUri: options.qrsRestUri + '/qrs/compositeeventoperational' + core.ifNotUndef(appendprivileges, '?privileges=' + appendprivileges, ''),
                    pfx: options.pfx,
                    passPhrase: options.passPhrase,
                    key: options.key,
                    cert: options.cert,
