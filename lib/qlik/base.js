...
exports.Base = {
    ...
    request: function(options, params) {
        ...
        if(typeof options.cert != 'undefined') settings.cert = options.cert;
        if(typeof options.ca != 'undefined') settings.ca = options.ca;
                ...
                apires.on('end', function (d) {
                    if(Math.floor(apires.statusCode / 100) <= 3) {
                        try {
                            ...
                            requestDef.resolve({ statusCode: apires.statusCode, statusMessage: apires.statusMessage, body: body});
                        }
                        ...
                        try {
                            ...
                            requestDef.reject({ statusCode: apires.statusCode, statusMessage: apires.statusMessage, body: body});
                        }
