...
exports.Advanced = {
     ...
     */
    addToWhiteList: function(options) {
     ...
     * @param {Task} options.params.task task that will trace the cloning progress
    ...
    export: function(options) {
        ...
        return Q().then(function() {
                ...
                app.createSessionObject({
                    ...
                    var dimensionMap = object.values(object.map(dimensions, function(dim, dimCode) {
                        return {
                            ...
                            dimension: dim,
                            qlikDimension: (dim.dimensionType == 'MASTER') ?
                ...
                app.createSessionObject({
                    ...
                    var measureMap = object.values(object.map(measures, function(mea, meaCode) {
                        return {
                            ...
                            measure: mea,
                            qlikMeasure: (mea.measureType == 'MASTER') ?
            ...
            var pages = [].concat.apply([], pages.map(function(item) {
                return item.qDataPages[0].qMatrix.map(function(row) {
