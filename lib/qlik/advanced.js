    ...
    loopAndReload: function(options, params, task) {
        ...
        return exports.Advanced.export(options, exportParams, task).then(function(reply) {
            ...
            var dynamicCloneParams = extend(true, {}, params.reload, {
                maxParDup: core.ifNotUndef(params.reload.maxParDup, 5),
                replacesDef: reply.map(function(item) {
                    return {
                        replaces: {marker: ((params.reload.replacesDef && params.reload.replacesDef.marker) ? core.ifNotUndef(params.reload.replacesDef.marker, '%Replace me!%') : '%Replace me!%'), value: core.ifNotUndef(reduceColumn, item[1], undefined)},
                        targetApp: core.ifNotUndef(nameColumn, item[2], undefined),
                        publishStream: core.ifNotUndef(publishColumn, item[3], undefined)
                    };
                }),
                overwriteApp: core.ifNotUndef(params.reload.overwriteApp, false)
            });
