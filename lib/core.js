...
exports.Core = {
    ...
    ifChildNotUndef: function(a, b, c, d) {
        ...
        if (arguments.length <= 3 && mb.length == 0) return exports.Core.ifNotUndef(a, c);
        else if (arguments.length > 3 && mb.length == 0) return exports.Core.ifNotUndef(a, c, d);
        else if (arguments.length <= 3 && typeof a !== 'undefined' && a != null && a.hasOwnProperty(mb[0])) return exports.Core.ifChildNotUndef(a[mb[0]], mb.slice(1), c);
        else if (arguments.length > 3 && typeof a !== 'undefined' && a != null && a.hasOwnProperty(mb[0])) return exports.Core.ifChildNotUndef(a[mb[0]], mb.slice(1), c, d);
        else if (arguments.length <= 3) return c;
        else if (arguments.length > 3) return d;
    },

    repeat: function(string, count) {
        if (string == null) {
            throw new TypeError('Can\'t convert ' + string + ' in object');
        }
        var str = '' + string;
        count = +count;
        ...
        if (str.length * count >= 1 << 28) {
            throw new RangeError('count is too high');
        }
    ...
    Task: function() {
        ...
        var parseDetail = function(detail, args) {
            if (typeof detail === 'undefined') {
                return;
            } else if (typeof detail !== 'string') {
                return detail;
            } else {
                return vsprintf(detail, object.values(args).slice(2).map(function(item) {
        ...
        this.once = function(func) {
            ...
            if (_this.status == 'done' || _this.status == 'failed') {
                func(_this);
            }
        };
        ...
        this.running = function(val, detail) {
            return changeStatus('running', val, parseDetail(detail, arguments));
        };
        ...
        this.done = function(val, detail) {
            return changeStatus('done', val, parseDetail(detail, arguments));
        };
        ...
        this.failed = function(val, detail) {
            return changeStatus('failed', val, parseDetail(detail, arguments));
        };
